...
//		System.out.println(false & (5 / 0 == 0) ); 	// Runtime Exception
		System.out.println(false && (5 / 0 == 0) );	// false----> and opeartor
//		System.out.println(true | (5 / 0 == 0) );	// Runtime Exception
		System.out.println(true || (5 / 0 == 0) );	// true----> or opearator
		System.out.println("!true = " + !true);		// false----> not operator
		System.out.println(true ^ true); 			// false----> ex-or operator
